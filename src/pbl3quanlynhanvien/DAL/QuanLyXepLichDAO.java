...
public class QuanLyXepLichDAO {
    ...
    public void quanlylich() throws Exception {
        ...
        luudulieuthanhvienban(phaches, phachec, phachet, manvpc, h);
        xuat(phaches, h, n);
        System.out.println();
        xuat(phachec, h, n);
        System.out.println();
        ...
        luudulieuthanhvienban(phucvus, phucvuc, phucvut, manvpv, m);
        xuat(phucvus, m, n);
        System.out.println();
        xuat(phucvuc, m, n);
        System.out.println();
    ...
    public void luudulieuthanhvienban(int s[][], int c[][], int t[][], String mnv[], int slnv) throws Exception {
